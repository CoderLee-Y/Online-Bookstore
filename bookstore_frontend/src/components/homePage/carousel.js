        ...
        return (
            <div>
                <div class="col-md-8 col-md-offset-2">
                    <Carousel autoplay>
                        <div class="col-md-12">
                            <img src={this.props.src1} class="img-responsive  center-block"
                                alt="Responsive image" align='middle' aria-hidden />
                        </div>
                        <div class="col-md-12">
                            <img src={this.props.src2} class="img-responsive  center-block"
                                alt="Responsive image" align='middle' aria-hidden />
                        </div>
                        <div class="col-md-12">
                            <img src={this.props.src3} class="img-responsive  center-block"
                                alt="Responsive image" align='middle' aria-hidden />
                        </div>
                        <div class="col-md-12">
                            <img src={this.props.src4} class="img-responsive center-block"
                                alt="Responsive image" align='middle' aria-hidden />
                        </div>
                    </Carousel>
                </div>
