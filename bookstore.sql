...
-- Records of book
-- ----------------------------
INSERT INTO `book` (isbn, name, type, author, price, description, inventory, image)
VALUES ('1', 'Java核心技术卷II', '编程', '凯S.霍斯特曼', '95.20',
        ...
        '1000', 'http://img3m9.ddimg.cn/12/36/1546133799-1_w_1.jpg');
INSERT INTO `book` (isbn, name, type, author, price, description, inventory, image)
...
VALUES ('30', '东方快车谋杀案', '悬疑/推理小说', '阿加莎·克里斯蒂', '28.8',
        ...
        '1551',
        'https://i.loli.net/2021/07/05/1zMuPlj2i6GoJKL.jpg');
INSERT INTO `book`(isbn, name, type, author, price, description, inventory, image)
VALUES ('31', '他改变了中国', '人物传记', '罗伯特·劳伦斯·库恩', '19.99',
        ...
        '1551',
        'https://img0.baidu.com/it/u=547223945,730321915&fm=224&fmt=auto&gp=0.jpg');
INSERT INTO `book`(isbn, name, type, author, price, description, inventory, image)
VALUES ('32', '编译原理：龙', '编程', 'Alfred V. Aho', '27.65',
        ...
        '1551',
        'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=4190271963,3321500896&fm=11&gp=0.jpg');
